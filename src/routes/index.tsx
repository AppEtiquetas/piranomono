    ...
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-primary/20">
      ...
      >
        <nav className="container mx-auto px-4 md:px-6 h-20 flex items-center justify-between relative">
          <img src={logoAsset.url} alt="Piranomono Logo" className="h-8 md:h-10 w-auto hover:scale-105 transition-transform cursor-pointer" />
        ...
        <section id="sobre" className="bg-secondary/20 py-20 md:py-32 border-y border-white/5 overflow-hidden">
          <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
            ...
            >
              ...
              <img src={logoAsset.url} alt="Mascote Piranomono" className="max-w-[200px] sm:max-w-[300px] md:max-w-md animate-float relative z-10 drop-shadow-[0_20px_50px_rgba(247,147,30,0.3)]" />
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 50 }}
              whileInView={{ opacity: 1, x: 0 }}
